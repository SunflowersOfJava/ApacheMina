...
import com.boonya.mina.protocol.pack.handler.ProtocolPackageServerHandler;

/**
 * 自定义消息协议-服务器
 * 
 * @package com.boonya.mina.protocol.pack.ProtocolPackageServer
 * @date 2017年1月10日 上午10:47:28
 * @author pengjunlin
 * @comment
 * @update
 */
public class ProtocolPackageServer {
	...
	public void init() throws IOException {
		...
		chain.addLast("codec", new ProtocolCodecFilter(
				new ProtocolPackageCodecFactory()));

		// 添加数据处理的处理器
		acceptor.setHandler(new ProtocolPackageServerHandler());
	...
	public static void main(String[] args) throws IOException {
		new ProtocolPackageServer().init();
	}
}
